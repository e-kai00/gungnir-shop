...
class Shipping(models.Model):
    ...
    def estimated_delivery(self):
        ...
        The delivery range is represented as string in the format "day month - day month",
        where the first day is the earliest estimated delivery and the second day is 
    ...
    def order_dispatch(self):
        """
        Calculate dispatch date based on 'processing_time' of the model instance.
        The dispatch date is represented as string in the format "day month".
        """
